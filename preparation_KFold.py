...
working_path = "./volumes_modified/"
train_img = np.load("./volumes_modified/trainImages.npy")
train_mask = np.load("./volumes_modified/trainMasks.npy")
print(train_img.shape,train_mask.shape)

test_img = np.load("./volumes_modified/testImages.npy")
test_mask = np.load("./volumes_modified/testMasks.npy")
